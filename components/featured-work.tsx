...
const featuredProjects = [
  {
    ...
    description: "Translation and editorial adaptation for bilingual exhibition materials focused on historical accessibility and tone preservation.",
    caseStudy: true,
  },
  {
    category: "Game Translation",
    title: "RPG Game Localization",
    description: "Localized UI, store assets, dialogue, and patch notes for Traditional Chinese-speaking audiences.",
    caseStudy: true,
  },
]
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight leading-[1.1] max-w-2xl">
            Selected translation and localization projects.
          </h2>
        </div>
